...
const fetchSingleRecipe = async () => {
    try {
        ...
        state.name.value = data.data.name;
        state.description.value = data.data.description;
        state.instructions.value = data.data.instructions;
        state.ingredients.value = data.data.ingredients.map((ingredient: Ingredient) => {
            return {
        ...
        state.image.value = data.data.image ?? "";
        state.created_at = data.data.created_at;
        setTimeout(async () => {
...
const sendRecipe = async () => {
    try {
        ...
        await axios.put(`${url}/${id}`, params, config);
    } catch (error) {
